...
target 'torus-direct-swift-sdk-mock-example' do
  ...
  pod 'Torus-directSDK', :git => 'https://github.com/torusresearch/torus-direct-swift-sdk.git', :branch => 'fix/http-stubs'
  pod 'Torus-utils', :git => 'https://github.com/torusresearch/torus-utils-swift.git', :branch => 'fix/http-stubs'
