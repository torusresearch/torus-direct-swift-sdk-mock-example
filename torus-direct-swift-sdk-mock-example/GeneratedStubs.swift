...
"""
    ...
    let ret = stub(condition: isHost("www.googleapis.com") && isScheme("https:") && isPath("/userinfo/v2/me") && isMethodGET() && hasJsonBody(requestBody as! [AnyHashable : Any]) && hasHeaders(requestHeaders)){ _ in
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("ropsten.infura.io") && isScheme("https:") && isPath("/v3/b8cdb0e4cff24599a286bf8e87ff1c96") && isMethodPOST() && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("teal-15-2.torusnode.com") && isScheme("https:") && isPath("/jrpc") && isMethodPOST() && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("signer.tor.us") && isScheme("https:") && isPath("/api/allow") && isMethodGET() && hasJsonBody(requestBody as! [AnyHashable : Any]) && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("teal-15-3.torusnode.com") && isScheme("https:") && isPath("/jrpc") && isMethodPOST() && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("teal-15-1.torusnode.com") && isScheme("https:") && isPath("/jrpc") && isMethodPOST() && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("teal-15-4.torusnode.com") && isScheme("https:") && isPath("/jrpc") && isMethodPOST() && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("metadata.tor.us") && isScheme("https:") && isPath("/get") && isMethodPOST() && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
...
"""
    ...
    let requestHeaders = try! JSONSerialization.jsonObject(with: Data(requestHeadersStr.utf8), options:  []) as! [String: String]
    let responseHeaders = try! JSONSerialization.jsonObject(with: Data(responseHeadersStr.utf8), options:  []) as! [String: String]
    let ret = stub(condition: isHost("teal-15-5.torusnode.com") && isScheme("https:") && isPath("/jrpc") && isMethodPOST() && hasHeaders(requestHeaders)){ _ in
        return HTTPStubsResponse(
            data: Data(responseBodyStr.utf8),
            statusCode: 200,
            headers: responseHeaders
